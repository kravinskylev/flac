...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'flac.com'
  config.app_name = 'Flac'
  config.mailer.from = 'Flac <no-reply@flac.com>'
  ...
  #
  config.app_secret = 'UOUqVMZ-i5MFssv5n-AV4Lplhac_aOBhWRQ6S_SnnWO4mpdKDWAaLSAjNZjOzHvFjOY'
